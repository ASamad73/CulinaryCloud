...
//         // Try getting user ratings — if fails, assume empty
...
//         // Build userRating map based on backend
//         const userRatingMap = {};
//         userRatedRes.data.forEach(rating => {
//           userRatingMap[rating.recipeId] = rating.rating;
//         });
//         setUserRatings(userRatingMap); // ← only after fetching user's real ratings!
