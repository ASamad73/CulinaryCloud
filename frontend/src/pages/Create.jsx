...
//       <div className="recipe-title-conatiner">
//         <input
//           type="text"
...
//       newSteps[stepIndex].time.hours = !isNaN(numericValue) 
//         ? Math.max(0, numericValue).toString() 
//         : value;
//     } else if (field === "minutes") {
//       const numericValue = parseInt(value, 10);
//       newSteps[stepIndex].time.minutes = !isNaN(numericValue) 
//         ? Math.min(59, Math.max(0, numericValue)).toString() 
//         : value;
//     }
//     setSteps(newSteps);
//   };
...
//         errors[`step${index}_ingredients`] = "At least one ingredient is required";
//       }
//       step.ingredients.forEach((ingredient, ingIndex) => {
//         if (!ingredient.name.trim()) {
//           errors[`step${index}_ingredient${ingIndex}_name`] = "Ingredient name is required";
//         }
//         if (ingredient.quantity === "" || isNaN(ingredient.quantity) || Number(ingredient.quantity) < 0) {
//           errors[`step${index}_ingredient${ingIndex}_quantity`] = "Quantity must be a non-negative number";
//         }
//         if (!ingredient.unit) {
//           errors[`step${index}_ingredient${ingIndex}_unit`] = "Unit is required";
//         }
//       });
//       if (!step.description.trim()) {
//         errors[`step${index}_description`] = "Description is required";
//       }
//       if (step.time.hours !== "" || step.time.minutes !== "") {
//         const hours = Number(step.time.hours);
//         const minutes = Number(step.time.minutes);
//         if (isNaN(hours)) {
//           errors[`step${index}_time_hours`] = "Hours must be a number";
//         }
//         if (isNaN(minutes)) {
//           errors[`step${index}_time_minutes`] = "Minutes must be a number";
//         }
//       }
//     });
...
//           <h3 className="step-number">Step {stepIndex + 1}</h3>
//           <h5 className="step-titles">Ingredients</h5>
//           {errors[`step${stepIndex}_ingredients`] && <p className="error">{errors[`step${stepIndex}_ingredients`]}</p>}
//           <div className="ingredients">
//             {step.ingredients.map((ingredient, ingredientIndex) => (
//               <div key={ingredientIndex} className="single-ingredient">
//                 <input
...
//                   }
//                 />
//                 {errors[`step${stepIndex}_ingredient${ingredientIndex}_name`] && <p className="error">{errors[`step${stepIndex}_ingredient${ingredientIndex}_name`]}</p>}
//                 <input
//                   type="number"
//                   placeholder="Quantity"
//                   className="input-quantity-field"
...
//                   step="0.01"
//                 />
//                 {errors[`step${stepIndex}_ingredient${ingredientIndex}_quantity`] && <p className="error">{errors[`step${stepIndex}_ingredient${ingredientIndex}_quantity`]}</p>}
//                 <select
//                   className="input-unit-field"
//                   value={ingredient.unit}
//                   onChange={(e) =>
...
//                   <option value="piece">piece</option>
//                 </select>
//                 {errors[`step${stepIndex}_ingredient${ingredientIndex}_unit`] && <p className="error">{errors[`step${stepIndex}_ingredient${ingredientIndex}_unit`]}</p>}
//                 {ingredientIndex === step.ingredients.length - 1 && (
//                   <div className="ingredient-btns">
//                     <button
//                       onClick={() => addIngredient(stepIndex)}
...
//             }
//           />
//           {errors[`step${stepIndex}_description`] && <p className="error">{errors[`step${stepIndex}_description`]}</p>}
//           <h5 className="step-titles">Time (if applicable)</h5>
//           <div className="time-container">
//             <input
//               type="number"
...
//               }
//             />
//             {errors[`step${stepIndex}_time_hours`] && <p className="error">{errors[`step${stepIndex}_time_hours`]}</p>}
//             <input
//               type="number"
//               placeholder="mins"
//               className="time-field2"
...
//               }
//             />
//             {errors[`step${stepIndex}_time_minutes`] && <p className="error">{errors[`step${stepIndex}_time_minutes`]}</p>}
//           </div>
//         </div>
//       ))}
//       <button className="delete-step" onClick={() => deleteStep(steps.length - 1)}>
...
// // ye file change ki ha bus , create .jsx
import { useState } from "react";
import Select from "react-select";
import { useNavigate } from "react-router-dom";
import axios from "axios";
